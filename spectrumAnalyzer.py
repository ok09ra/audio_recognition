...
main ref = https://takeshid.hatenadiary.jp/entry/2015/11/27/045123
...
class PlotWindow:
    def __init__(self):
        ...
        self.audio=pyaudio.PyAudio() #pyaudioのインスタンス作成
        self.stream=self.audio.open(format=pyaudio.paInt16, #16bit音源
                                    channels=1, #モノラル
                                    rate=self.RATE, #サンプリング周波数
                                    input=True,
